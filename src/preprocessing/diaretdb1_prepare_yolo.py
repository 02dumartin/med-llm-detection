#!/usr/bin/env python3
"""
DIARETDB1 COCO JSON → YOLO 변환 스크립트.

입력 (diaretdb1_prepare.py에서 생성, IDRiD처럼 train+test 합쳐 test로):
  - 4cls: /home/jovyan/aicon-gamma-datavol-1/hjgoh/med-llm-data/DIARETDB1_4cls/test/test.json
  - 1cls: /home/jovyan/aicon-gamma-datavol-1/hjgoh/med-llm-data/DIARETDB1_1cls/test/test.json

출력:
  - 4cls: /home/jovyan/aicon-gamma-datavol-1/hjgoh/med-llm-data/DIARETDB1_yolo_4cls/test/{images,labels}
  - 1cls: /home/jovyan/aicon-gamma-datavol-1/hjgoh/med-llm-data/DIARETDB1_yolo_1cls/test/{images,labels}
...
# COCO 입력 (diaretdb1_prepare.py 출력)
...
def convert_coco_to_yolo(coco_root: Path, yolo_root: Path, split_name: str, is_1cls: bool = False):
    """COCO {split}/{split}.json → YOLO {split}/{images,labels}"""
